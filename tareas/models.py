...
class registroTareas(models.Model):
    ...
    fecha_vencimiento_tarea = models.DateTimeField( default=timezone.localtime,  verbose_name="Fecha vencimiento tarea (dd-mm-yyyy)")
    ...
    def __str__(self):
        return "Id: %s, Nombre Tarea: %s, Descripción tarea: %s,  Vencimiento tarea: %s, Categoria: %s, Estado: %s" %(self.id_tarea, self.titulo_tarea, self.descripcion_tarea, self.fecha_vencimiento_tarea, self.categoria_tarea, self.estado_tarea)
