...
from tareas.views import formularioRegistroTareas, administraTareas, modificaTareas, eliminaTareas, completaTareas
from tareas.views import user_login, registro
